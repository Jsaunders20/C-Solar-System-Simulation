...
int main(int argc, char *argv[]){
	...
	if(argc < 6){
		...
		cout << "A and P are the Aphilion and Perihilion of the planet in 10^6 Km, e is the eccentricity of the orbit, and target_T is the period in days" << endl;
		return -1;
	}
	...
	T = 200.; //none of the periods in our solar system are supposed to be greater than 200 years
